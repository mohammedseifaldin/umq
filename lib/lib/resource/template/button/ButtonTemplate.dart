...
class ButtonTemplate {
  ...
  static Widget t(String text, VoidCallback? onPressed,
    ...
    //text
    var txt =
        _getText(text, textAlign, textColor_ds, textDimen_ds, padding, font_ds);

    //style button
    ButtonStyle style = _getButtonStyle(
        backgroundColor_ds, width, height, borderLine, borderRadius, textDimen);
