...
class ItemMessageStateFullWidget extends StatefulWidget {
  ...
  ItemMessageStateFullWidget(
      this.parentState, this.position, this.mChatMessage);
...
class ItemMessageStateFullWidgetState
    extends State<ItemMessageStateFullWidget> {
  @override
  Widget build(BuildContext context) {
    //Log.i("build() - ItemMessageStateFullWidgetState");
    return ItemMessageState(
        widget.parentState, widget.position, widget.mChatMessage,
...
class ItemMessageState extends StatelessWidget {
  ...
  Widget ItemMessageViewItem() {
    ...
    //choose type owner
    bool isSenderType =
        ToolsMChatMessage.isSender(mChatMessage, parentState.myUserId);
    if (isSenderType) {
