...
extension ChatFileInputController on InputMessageState {
  Future attachClick() async {
    Log.i("attachClick()");

    _listenerPickerFileTypeImage();
  }


  Future _listenerPickerFileTypeImage() async {
    //step : picker
    await AttachTools.typePickerFile( DrawableProject.placeholderImage,
