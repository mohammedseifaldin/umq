...
class ToolbarChatHome extends StatefulWidget {
  ...
  ToolbarChatHome(this.contextPage, this.myTitle, {super.key});
...
class ToolbarChatHomeState extends State<ToolbarChatHome> {
  ...
  Widget shadowCardViewCustomeRadius(Widget child) {
    ...
    //custome radius
    var objRadius = const Radius.circular(15);
    var radiusCustom =
        BorderRadius.only(bottomLeft: objRadius, bottomRight: objRadius);
