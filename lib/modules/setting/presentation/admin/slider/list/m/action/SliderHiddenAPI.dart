...
class SliderHiddenAPI {
  ...
  Future _startAPI() async {
    //{{local_v2}}/sliders/hidden
    String url = BackendConstant.baseUrlv2 + "/sliders/hidden";
    ...
    body["target"] = target;
    body["value"] = 0; //zero will change  status to "zero", means hidden
