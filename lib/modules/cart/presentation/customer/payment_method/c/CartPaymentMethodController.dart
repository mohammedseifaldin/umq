...
extension CartPaymentMethodController on CartPaymentMethodState {
  ...
  Future setEditPaymentMethod() async {
      ...
      Log.i( "setEditPaymentMethod() - current: " + current.toString() );
      //set
  ...
  Future clickNext() async {
    ...
    Log.i( "clickNext() - groupValue_method: " + groupValue_method.toString() );
  ...
  void handlerRadio_paymentMethod(String value) {
    Log.i( "handlerRadio_paymentMethod() - value: " + value.toString()  );

    //set current
    OrderCurrentSingletone.instance().paymentMethod = value;

    setState(() {
      this.groupValue_method = value;
    });
  }
