...
extension PaymentInfoOrderDetail on OrderDetailAdminState {
  ...
  Widget noticeShipmentFees(){
    ...
    var nameTv = TextTemplate.t( getMessageShippmentFess(), levelDS: LevelDS.l3 ,
  ...
  Widget tvTitle() {
    return TextTemplate.t( "Payment information" ,
        levelDS: LevelDS.l1
    );
  }
  ...
  String getNameOfPaymentMethod(){
    ...
    bool isHaveOnlineTransactionId = ToolsValidation.isValid( widget.mShow.paymentOnlineId );
