...
extension SecondBoarder on WalkThroughPageState {


  Widget secondBoarder() {
...
//---------------------------------------------------------------------- image
  ...
  Widget im_boarder() {
    return ImageView(width: DeviceTools.getWidth(context), height: 275 ,
      assetBackground: DrawableProject.boarder_2,
    );
  }
  ...
  Widget tv_scubaWorld() {
    return TextTemplate.t( TranslateLanguage.lang("diverOffer" ),
  ...
  Widget tv_detal(){
    return TextTemplate.t( TranslateLanguage.lang( "scuba_splash_message_diverOffer" ),
      levelDS: LevelDS.l2,
