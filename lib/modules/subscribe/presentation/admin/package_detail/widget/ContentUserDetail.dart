...
extension ContentUserDetail on SubscribePackageDetailAdminState {
  ...
  Widget name_en() {
    var row = RowTemplate.scroll(contextPage!, [_tv_nameEn(), _tf_nameEn()]);
  ...
  Widget name_ar() {
    var row = RowTemplate.scroll(contextPage!, [_tv_nameAr(), _tf_nameAr()]);
  ...
  Widget desc_en() {
    var row = RowTemplate.scroll(contextPage!, [_tv_descEn(), _tf_descEn()]);
  ...
  Widget _tf_descEn() {
    return TextFieldFastor(
        width: AdminDSDimen.inputFiled_value_width,
        hint_text:
            widget.mEdit != null ? widget.mEdit!.descriptionEn ?? "" : null,
        autovalidateMode: AutovalidateMode.onUserInteraction,
        validatorCustom: ValidatorTemplate.name(),
        keyboardType: TextInputType.name,
        decoration: BoarderHelper.box(),
  ...
  Widget desc_ar() {
    var row = RowTemplate.scroll(contextPage!, [_tv_descAr(), _tf_descAr()]);
  ...
  Widget _tf_descAr() {
    return TextFieldFastor(
        width: AdminDSDimen.inputFiled_value_width,
        hint_text:
            widget.mEdit != null ? widget.mEdit!.descriptionAr ?? "" : null,
        autovalidateMode: AutovalidateMode.onUserInteraction,
        validatorCustom: ValidatorTemplate.name(),
        keyboardType: TextInputType.name,
        decoration: BoarderHelper.box(),
  ...
  Widget price() {
    var row = RowTemplate.scroll(contextPage!, [_tv_price(), _tf_price()]);
  ...
  Widget _tf_price() {
    return TextFieldFastor(
        width: AdminDSDimen.inputFiled_value_width,
        hint_text:
            widget.mEdit != null ? widget.mEdit!.price.toString() ?? "" : null,
        autovalidateMode: AutovalidateMode.onUserInteraction,
  ...
  Widget period() {
    var row = RowTemplate.scroll(contextPage!, [_tv_period(), _tf_period()]);
  ...
  Widget _tf_period() {
    return TextFieldFastor(
        width: AdminDSDimen.inputFiled_value_width,
        hint_text:
            widget.mEdit != null ? widget.mEdit!.period.toString() ?? "" : null,
        autovalidateMode: AutovalidateMode.onUserInteraction,
        validatorCustom: ValidatorTemplate.d(),
        keyboardType: TextInputType.number,
        decoration: BoarderHelper.box(),
  ...
  Widget product_numbers() {
    var row = RowTemplate.scroll(
        contextPage!, [_tv_product_numbers(), _tf_product_numbers()]);
  ...
  Widget allow_chat() {
    var row = RowTemplate.scroll(
        contextPage!, [_tv_allow_chat(), _switch_allow_chat()]);
  ...
  Widget _switch_allow_chat() {
    return SwitchFastor(
        defaultValue: request.allowedChat ?? true,
