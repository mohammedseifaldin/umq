...
import 'package:umq/modules/subscribe/presentation/admin/user_list/widget/ExtenstionColum.dart';
import 'package:umq/modules/subscribe/presentation/admin/user_list/widget/ExtenstionRow.dart';

import 'package:umq/toolsUI/toast/ToastTools.dart';

extension  MapModelToWidget on SubscribeUsersListAdminPageState {
  ...
  void initRowWidgetTableAndSetHeaderData(){
   ...
   mapResponseArrayToWidget()  {
    ...
    if( provider!.responseSubscribeUsers == null ) return;
    if( provider!.responseSubscribeUsers!.data == null ) return;

    ///list data
    var dataList = provider!.responseSubscribeUsers!.data!.data!;
