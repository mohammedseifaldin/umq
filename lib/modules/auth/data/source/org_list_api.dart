...
import '../../../profile/data/source/ResponseOrgList.dart';

typedef OrgListCallBack = Function(
    bool status, String msg, ResponseOrgList response);
...
class OrgListAPI {
  ...
  Future _startAPIGetAll() async {
    ...
    if (page == null) {
      url =
          "${BackendConstant.baseUrlv1}/organization/?paginator=10000000&page=1";
    } else {
      url =
          "${BackendConstant.baseUrlv1}/organization/?paginator=10&page=$page";
    }
