...
extension ContentUserDetail on NotificationCreateAdminState {
  ...
  Widget showNamePicker() {
    ...
    return TextTemplate.t(userSelected!.name!,
        margin: EdgeInsets.only(
            ...
            left: AdminDSDimen.inputFiled_title_width), onPressed: () async {
  ...
  Widget title() {
    var row = RowTemplate.scroll(context, [tv_title(), tf_title()]);
  ...
  Widget message() {
    var row = RowTemplate.scroll(context, [tv_message(), tf_message()]);
