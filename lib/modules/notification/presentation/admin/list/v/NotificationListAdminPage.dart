...
class NotificationListAdminPage extends StatefulWidget {
  ...
  NotificationListAdminState createState() {
    return  NotificationListAdminState();
  }
}

class NotificationListAdminState extends ResumableState<NotificationListAdminPage > {

  //--------------------------------------------------------------- data and varaible

  //title
  String pageTitle = "Notify";

  //response and table
  late TableViewFastorState tbState;
  ResponseNotificationListPaginate response = ResponseNotificationListPaginate();
  List<MNotificationAdmin> listProjectFiltered = []; //the list of project after fliter done
  ...
  Widget tooblar(){
    return AdminToolbar(
      ...
      clickRefresh : (b){
        ...
        createPageNameGoTo: NotificationCreateAdminPage(),
      resume: this,
