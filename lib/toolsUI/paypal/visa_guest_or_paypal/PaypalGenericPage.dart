...
import 'package:umq/toolsUI/paypal/visa_guest_or_paypal/logic/checker_payment_status_complete.dart';
...
import 'package:umq/toolsUI/paypal/visa_guest_or_paypal/widget/webviewPayment/webview_payment_page.dart';
...
class PaypalGenericPage extends StatefulWidget {
  ...
  PaypalGenericPage({required this.price, required this.payPalCallBack});
