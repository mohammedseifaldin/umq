...
class HtmlPreviewWidget extends StatefulWidget {
  ...
  @override
  HtmlPreviewState createState()  => HtmlPreviewState(this.htmlData);
...
class HtmlPreviewState extends State<HtmlPreviewWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    Log.i( "HtmlPreviewState - isValidHtml: " +  isValidHtml.toString() );
    if( isValidHtml ) {
  ...
  Widget typeShowContentHtml(String content) {
    return HtmlWidget(
      ...
      //text color
     textStyle: TextStyle(fontSize: DSDimen.text_level_1,
         fontFamily: DSFont.h1,
         color: Colors.black,
         decoration: TextDecoration.none) ,
      customStylesBuilder: (element) {return {'color': 'black'}; },
    );
  }
  ...
  Widget typeProgressDownloadData() {
    ...
    return Container( child: prg, margin: EdgeInsets.all( 40),);
  }
}
