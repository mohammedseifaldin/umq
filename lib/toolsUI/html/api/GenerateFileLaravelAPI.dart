...
typedef GenerateFileCallBack = Function(bool status, String msg , ResponseGenerateFile response );
...
class GenerateFileLaravelAPI   {
  ...
  late String content;  //example: /data/user/0/com.universityksa.university/cache/image_picker2894120432280038995.jpg
  ...
  void parseJson(Map<String, dynamic> mapJson ) {
    ...
    try {
      ...
      if ( ToolsAPI.isFailed( response.code) ) {
        callBack( false, response.message??"Failed To Generate File ", response ) ;
        return;
      }
