...
extension ExtenstionFastorColor on DesignSystemFastor {
  ...
  static Future _background() async {
    ...
    DSColor.ds_background_layout_3_transparent =
        HexColor(ColorProject.blueTransparent);
  }

  static Future _toolbarAppBar() async {
  ...
  static Future _text() async {
    ...
    DSColor.ds_text_h2_for_background_dark_typeTitle =
        HexColor(ColorProject.white_sun_4);
    DSColor.ds_text_h2_for_background_dark_typeSmall =
        HexColor(ColorProject.white_sun_4);
  ...
  static Future _textField_and_spiiner() async {
    ...
    DSColor.ds_textfield_hint =
        HexColor(ColorProject.greyDark); // HexColor( ColorProject.yellow_3);
    ...
    DSColor.ds_textfield_boarder_background =
    ...
    DSColor.spinner_underline = DSColor.spinner_background;
    DSColor.spinner_hint = DSColor.ds_textfield_hint;
  }
  ...
  static Future _other() async {
    ...
    DSColor.separatorLine_backgroundWhite =
        HexColor(ColorProject.blueTransparent);
  ...
  static _table() {
    ...
    DSColor.table_header_title =
        HexColor(ColorProject.blueCerulean_3); //blue_fish_front
    DSColor.table_header_boader =
        HexColor(ColorProject.blueTransparent); //black_1
    DSColor.table_row_background =
        HexColor(ColorProject.blueTransparent_white_sun_1);
