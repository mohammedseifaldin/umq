...
import 'package:umq/toolsUI/dialog/MaterialTransparentRoute.dart';
...
class GoToAdmin {
  ...
  static void userList( BuildContext context ) {
    NavigationTools.pushAndRemoveUntil( context,  UserListAdminPage( ) );
  }

  static void userDetail_edit( BuildContext context , MUser mEdit, ResumableState resume ) {
    NavigationTools.pushResume( context,  UserDetailAdminPage(edit: mEdit), resume);
  }
  ...
  static void pickerUser(BuildContext context, ResumableState? resume , {required ValueChanged<MUser> select}  ) {
  ...
  static void cityDetail_edit( BuildContext context , MCity mEdit, ResumableState resume ) {
    NavigationTools.pushResume( context,  CityDetailAdminPage(edit: mEdit), resume);
  }
  ...
  static void orgiizationDetail_edit( BuildContext context , MOrganization mEdit, ResumableState resume ) {
    NavigationTools.pushResume( context,  OrgDetailAdminPage(edit: mEdit), resume);
  }

  //----------------------------------------------------------------- slide

  static void slideDetail_edit(BuildContext context, MSlider mEdit, ResumableState resume) {
    NavigationTools.pushResume( context,  SlideDetailAdminPage(edit: mEdit), resume);
  }

  static void slideList(BuildContext context) {
    NavigationTools.pushAndRemoveUntil( context,  SliderListAdminPage( ) );
  }
  ...
  static void orderDetail_edit( BuildContext context , MOrder mEdit, ResumableState resume ) {
...
//-------------------------------------------------------------------- notification
  ...
  static void notificationAdminList( BuildContext context ) {
    NavigationTools.pushAndRemoveUntil( context,    NotificationListAdminPage() );
  }


  static void notificationAdminDetail_create( BuildContext context  , ResumableState resume ) {
  ...
  static void subscribePackageListAdmin(BuildContext context ) {
    NavigationTools.pushAndRemoveUntil( context,  SubscribePackageListAdminPage(   ) );
  }


  static void subscribePackageDetailAdmin(BuildContext context, MSubscribePackage? mEdit, ResumableState  resume) {
    NavigationTools.pushResume( context,  SubscribePackageDetailAdminPage(  mEdit: mEdit ), resume);
  }
  ...
  static void subscribeUserByAdmin(BuildContext context , ResumableState  resume) {
