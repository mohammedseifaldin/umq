...
class FCMSubscribe {
  static Future allUserSpecificPlatform() async {
    ...
    if (await FCMSubscribe.isSubscribeToAllUserBefore()) {
      Log.i(
          "fcm - allUserSpecificPlatform() - isSubscribeToAllUserBefore -  stop !");
      return;
    }
    ...
    await FirebaseMessaging.instance
        .subscribeToTopic(keySubscribeAll)
        .then((value) {
      Log.i(
          "fcm - allUserSpecificPlatform() - success key: " + keySubscribeAll);
  ...
  static Future userRemoveRole() async {
    ...
    String userRoleType = await FCMSubscribe._generateKeyRoleType();
    await FirebaseMessaging.instance
        .unsubscribeFromTopic(userRoleType)
        .then((value) {
  ...
  static Future userSpecificPlatform_add() async {
    ...
    //current platform
    String keySubscribePlatfrom =
        await FCMSubscribe._generateKeyUserId_addPlatform();
    Log.i("fcm - userSpecificPlatform_add() - keySubscribePlatfrom: " +
        keySubscribePlatfrom);
    await FirebaseMessaging.instance
        .subscribeToTopic(keySubscribePlatfrom)
        .then((value) {
      Log.i("fcm - userSpecificPlatform_add() - success - topic: " +
          keySubscribePlatfrom);
    });
    ...
    await FirebaseMessaging.instance
        .subscribeToTopic(keySubscribeOnly)
        .then((value) {
      Log.i("fcm - userSpecificPlatform_add() - keySubscribeOnly: " +
          keySubscribeOnly);
    });
  ...
  static Future userSpecificPlatform_remove() async {
    ...
    try {
      ...
      String keySubscribePlatfrom =
          await FCMSubscribe._generateKeyUserId_addPlatform();
      await FirebaseMessaging.instance
          .unsubscribeFromTopic(keySubscribePlatfrom)
          .then((value) {
        Log.i("fcm - userSpecificPlatform_remove() - keySubscribePlatfrom: " +
            keySubscribePlatfrom);
      });
      ...
      String keySubscribeOnly = await FCMSubscribe._generateKeyUserId_only();
      await FirebaseMessaging.instance
          .unsubscribeFromTopic(keySubscribeOnly)
          .then((value) {
        Log.i("fcm - userSpecificPlatform_remove() - keySubscribeOnly: " +
            keySubscribeOnly);
      });
      ...
      await FirebaseMessaging.instance
          .unsubscribeFromTopic(userRoleType)
          .then((value) {
        Log.i("fcm - userSpecificPlatform_remove() - userRoleType: " +
            userRoleType);
      });
    } catch (e) {
