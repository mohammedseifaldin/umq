...
class ResponsiveFourmMobile {
  ...
  static Widget wrapHeight(BuildContext context, Widget content) {
    ...
    //stack
    var stack = StackTemplate.AlignParentPage(
        context: context, alignCenterTop: _cardViewWrap(context, content));

    //margin to parent
    return Container(
        child: stack, margin: EdgeInsets.all(DSDimen.space_parent));
  }
  ...
  static Widget _cardViewWrap(BuildContext context, Widget content) {
    ...
    return Container(
      ...
      decoration:
          DeviceTools.isPlatformWeb() ? BoarderHelper.cardViewShadow() : null,
    );
  }
  ...
  static Widget _cardviewFixedHeight(
