...
typedef UploadFileCallBack = Function(bool status, String msg , ResponseUploadFileLaravel response );
...
class UploadFileLaravelAPI   {
  ...
  @Deprecated("this not working in Web Platform, use method (getDataByXFile) instead")
  ...
  Future _startAPI() async  {
    ...
    NetworkRequestFile? requestFile =  null ;
    if( xFile != null ) {
      requestFile = NetworkRequestFile.fromXFileAndBody( xFile!, bodyRequest);
    } else if( filePath != null ) {
      requestFile = NetworkRequestFile.fromFilePathAndBody( filePath!, bodyRequest);
    }
