class EnvironmentConstant {
  ...
  static const isMockAPI =
      false; //true: means just loop mock backend not the real backend from api request network
  static const isApiCache = false; //true: means force to get from cache backend

  static const int version = 380;

  static const bool isAutoWriteLoginData =
      isTest; //true: write login data to easly use
  ...
  static const bool businessEnglishOnly = true;

  // true: means make walthrought show forever

  static const bool businessWalkthroughForever = false;
